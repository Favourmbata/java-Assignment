...
//      }
////   }
////    private static String judgingingVsTypePersperctive( int nm) {
////  }
////    private static String thinkerVsFeeler(int i, int i1) {
////    }
////    private static String sensitiveVsIntuitive(int i, int i1) {
////    }
////    private static String extrovertVsIntrovert(int i, int i1) {
////    }
//
////
////    public static String checkPersonalityType(int []feedBack){
////        String personalityType = " ";
////        personalityType += extrovertVsIntrovert(feedBack[0],feedBack[1]);
////        personalityType += sensitiveVsIntuitive(feedBack[2],feedBack[3]);
////        personalityType += thinkerVsFeeler(feedBack[4],feedBack[5]);
//////        personalityType += judgingingVsTypePersperctive(feedBack[6],feedBack[7]);
