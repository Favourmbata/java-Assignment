...
public class ArithmeticOpertion {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("this is the sum of squared number" +sumedNumber1 + sumedNumber2);
        System.out.println("This is the difference of of the square"+differnceOfSquare);
    }
